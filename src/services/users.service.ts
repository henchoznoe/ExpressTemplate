...
import type { CreateUserSchemaType, UpdateUserSchemaType } from '@/schemas/auth.schema.js'
...
export class UserService {
    ...
    async updateUser(userId: string, userData: UpdateUserSchemaType): Promise<User | null> {
